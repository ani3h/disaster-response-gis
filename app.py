...
Main Flask Application Entry Point
===================================
This file initializes the Flask app, loads GIS layers,
registers API blueprints, configures CORS, and sets up
error handlers.
"""
...
# Load GIS data
from backend.core.data_loader import init_data
...
def create_app(cfg=config):
    ...
    # Load all GIS layers into memory
    with app.app_context():
        init_data(app)

...
DB_NAME = os.getenv('DB_NAME', 'disaster_response_gis')
DB_USER = os.getenv('DB_USER', 'postgres')
DB_PASSWORD = os.getenv('DB_PASSWORD', 'anish')
...
DISASTER_BUFFER_DISTANCE = int(
    os.getenv('DISASTER_BUFFER_DISTANCE', 5000))  # 5km
...
CACHE_DEFAULT_TIMEOUT = int(
    os.getenv('CACHE_DEFAULT_TIMEOUT', 300))  # 5 minutes
...
DISASTER_UPDATE_INTERVAL = int(
    os.getenv('DISASTER_UPDATE_INTERVAL', 60))  # 1 minute
TRAFFIC_UPDATE_INTERVAL = int(
    os.getenv('TRAFFIC_UPDATE_INTERVAL', 300))  # 5 minutes
WEATHER_UPDATE_INTERVAL = int(
    os.getenv('WEATHER_UPDATE_INTERVAL', 600))  # 10 minutes
...
ROUTING_ALGORITHM = os.getenv(
    'ROUTING_ALGORITHM', 'dijkstra')  # dijkstra, astar

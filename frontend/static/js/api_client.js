...
const API = {
    ...
    async getCyclones() {
        // const lines = await fetch(`/api/disaster/cyclone_lines`).then(r => r.json());
        // const points = await fetch(`/api/disaster/cyclone_points`).then(r => r.json());
        // return { lines, points };
        return fetch(`/api/disaster/cyclones`).then(r => r.json());
    },
    async getLandslides() {
        return fetch(`${this.BASE}/disaster/landslides`).then(r => r.json());
    },

    async getHospitals() {
        return fetch(`${this.BASE}/shelters/hospitals/all`).then(r => r.json());
    },

    async getShelters() {
        return fetch(`${this.BASE}/shelters/all`).then(r => r.json());
    },

    async getRoads() {
        return fetch(`${this.BASE}/layers/roads`).then(r => r.json());
    },

    async getBoundaries() {
        return fetch(`${this.BASE}/layers/boundaries`).then(r => r.json());
    },
